...
def init_widgets_list_top():
    ...
    widgets_list_top = [
                ...
                widget.Mpris2(name='Spotify',objname='org.mpris.MediaPlayorg.mpris.MediaPlayer2.spotify',scroll_chars=20,display_metadata=['xesam:artist','xesam:title'],background=colors[1],foreground=colors[16],fontshadow=colors[17],scroll_wait_intervals=0,scroll_interval=0.0,stop_pause_text='<pause/>'),
...
def init_widgets_list_bot():
    widgets_list_bot = [
                ...
                widget.NetGraph(interface = "enp6s0",foreground=colors[16],background=colors[2],padding=5),
