...
def init_widgets_list_bot():
    widgets_list_bot = [
                ...
                widget.Wlan(interface='enp6s0', format='{essid}', disconnected_message='Unplugged', foreground=colors[0], background=colors[1], fontshadow=colors[7]),
                widget.Net(interface="enp6s0", format='{down} ↓↑ {up}', foreground=colors[0], background=colors[1],padding=5, fontshadow=colors[7]),
